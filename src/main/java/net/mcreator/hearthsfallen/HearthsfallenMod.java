package net.mcreator.hearthsfallen;
...
@Mod("hearthsfallen")
public class HearthsfallenMod {
	public static final Logger LOGGER = LogManager.getLogger(HearthsfallenMod.class);
	public static final String MODID = "hearthsfallen";

	public HearthsfallenMod() {
		...
		HearthsfallenModTabs.REGISTRY.register(bus);
