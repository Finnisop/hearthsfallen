...
import net.mcreator.hearthsfallen.client.renderer.TestDummyRenderer;
...
public class HearthsfallenModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(HearthsfallenModEntities.TEST_DUMMY.get(), TestDummyRenderer::new);
	}
}
